...
export default function Waitlist() {
  return (
    <section className="text-white font-inter text-center max-w-[1600px] mx-auto flex flex-col gap-5 items-center">
      <h1 className="font-obostar text-[40px]">Join Today</h1>
      <p>Free to join, pay as you go</p>

      <form className="max-w-[600px] mb-12 w-full flex gap-3 justify-center items-stretch">
        <Input
          type="email"
